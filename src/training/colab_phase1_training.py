        ...
        **kwargs
        ...
        try:
            ...
            if self.strict_model_loading:
                raise RuntimeError(
                    f"MODEL_LOAD_STRICT failed: could not load pretrained model '{model_name}'."
                ) from e
        ...
        try:
            ...
            if self.strict_model_loading:
                raise RuntimeError("MODEL_LOAD_STRICT failed: could not apply DoRA PEFT adapter.") from e
