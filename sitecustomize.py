...
This module is auto-imported by Python and is used to:
1) Work around warnings filter instability on newer Python versions.
2) Keep tmp-path behavior stable in restricted/sandboxed Windows environments.
"""
...
# ---------------------------------------------------------------------------
# Temp-path stability for restricted local environments
# ---------------------------------------------------------------------------
