...
class TestIndependentCropAdapterPhase1:
    ...
    @pytest.fixture
    def phase1_setup(self, mock_dataset_factory):
        """Setup for Phase 1 testing using shared dataset factory."""
        train_dataset = mock_dataset_factory(classes=['disease0', 'disease1', 'disease2'], size=100)
        val_dataset = mock_dataset_factory(classes=['disease0', 'disease1', 'disease2'], size=50)
...
class TestIndependentCropAdapterPhase3:
    ...
    @pytest.fixture
    def phase3_setup(self, mock_dataset_factory):
        """Setup for Phase 3 testing using shared dataset factory."""
        adapter = IndependentCropAdapter(crop_name='tomato', device='cpu')
        adapter.is_trained = True
        ...
        # Use shared dataset factory for domain shift
        domain_shift_dataset = mock_dataset_factory(classes=['disease0', 'disease1'], size=50)
