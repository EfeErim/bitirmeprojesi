...
ADAPTER_RECS: dict[str, dict[str, Any]] = {
    "grape__fruit": {
        ...
        "defaults": {"EPOCHS": 32, "BATCH_SIZE": 48, "LEARNING_RATE": 1e-4, "LORA_R": 24, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.16, "OOD_FACTOR": 3.0, "LABEL_SMOOTHING": 0.10},
    },
    "grape__leaf": {
        ...
        "oe_enabled": True, "oe_w": 0.24, "allow_under_min": False,
        "defaults": {"EPOCHS": 30, "BATCH_SIZE": 56, "LEARNING_RATE": 1e-4, "LORA_R": 24, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.14, "OOD_FACTOR": 3.5, "LABEL_SMOOTHING": 0.10},
    },
    "strawberry__fruit": {
        ...
        "defaults": {"EPOCHS": 38, "BATCH_SIZE": 40, "LEARNING_RATE": 5e-5, "LORA_R": 20, "LORA_ALPHA": 26, "LORA_DROPOUT": 0.13, "OOD_FACTOR": 2.0, "LABEL_SMOOTHING": 0.05},
    },
    "strawberry__leaf": {
        ...
        "defaults": {"EPOCHS": 24, "BATCH_SIZE": 88, "LEARNING_RATE": 1.2e-4, "LORA_R": 24, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.125, "OOD_FACTOR": 4.0, "LABEL_SMOOTHING": 0.10, "EARLY_STOPPING_PATIENCE": 5},
    },
    "tomato__fruit": {
        ...
        "oe_enabled": True, "oe_w": 0.25, "allow_under_min": False,
        "defaults": {"EPOCHS": 30, "BATCH_SIZE": 64, "LEARNING_RATE": 6e-5, "LORA_R": 24, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.125, "OOD_FACTOR": 3.0, "LABEL_SMOOTHING": 0.10},
    },
    "tomato__leaf": {
        ...
        "oe_enabled": True, "oe_w": 0.25, "allow_under_min": False,
        "defaults": {"EPOCHS": 26, "BATCH_SIZE": 88, "LEARNING_RATE": 1.1e-4, "LORA_R": 32, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.125, "OOD_FACTOR": 3.5, "LABEL_SMOOTHING": 0.10},
    },
    "apricot__fruit": {
        ...
        "defaults": {"EPOCHS": 36, "BATCH_SIZE": 40, "LEARNING_RATE": 1e-4, "LORA_R": 20, "LORA_ALPHA": 20, "LORA_DROPOUT": 0.20, "OOD_FACTOR": 4.5, "LABEL_SMOOTHING": 0.10},
    },
    "apricot__leaf": {
        ...
        "oe_enabled": True, "oe_w": 0.25, "allow_under_min": False,
        "defaults": {"EPOCHS": 38, "BATCH_SIZE": 52, "LEARNING_RATE": 8.5e-5, "LORA_R": 26, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.125, "OOD_FACTOR": 5.5, "LABEL_SMOOTHING": 0.10},
    },
}
