...
ADAPTER_RECS = dict(globals().get("ADAPTER_RECS") or _SHARED_ADAPTER_RECS or {
    "grape__fruit": {
        ...
        "oe_enabled": True, "oe_w": 0.32, "allow_under_min": False,
        "defaults": {"EPOCHS": 34, "BATCH_SIZE": 48, "LEARNING_RATE": 1e-4, "LORA_R": 24, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.16, "OOD_FACTOR": 3.5, "LABEL_SMOOTHING": 0.08, "OE_LOSS_WEIGHT": 0.32, "REACT_ENABLED": True, "REACT_PERCENTILE": 0.985, "FUSION_DROPOUT": 0.14, "CLASSIFIER_REBALANCE_ENABLED": True, "CLASSIFIER_REBALANCE_LOGIT_ADJUSTMENT_TAU": 1.20},
    },
    "grape__leaf": {
        ...
        "defaults": {"EPOCHS": 30, "BATCH_SIZE": 56, "LEARNING_RATE": 1e-4, "LORA_R": 24, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.14, "OOD_FACTOR": 3.5, "LABEL_SMOOTHING": 0.08, "OE_LOSS_WEIGHT": 0.30, "REACT_ENABLED": True, "REACT_PERCENTILE": 0.985, "FUSION_DROPOUT": 0.12, "CLASSIFIER_REBALANCE_ENABLED": True, "CLASSIFIER_REBALANCE_LOGIT_ADJUSTMENT_TAU": 1.15},
    },
    "strawberry__fruit": {
        ...
        "oe_enabled": True, "oe_w": 0.25, "allow_under_min": True,
        "defaults": {"EPOCHS": 36, "BATCH_SIZE": 40, "LEARNING_RATE": 8e-5, "LORA_R": 20, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.125, "OOD_FACTOR": 2.0, "LABEL_SMOOTHING": 0.10, "OE_LOSS_WEIGHT": 0.25, "REACT_ENABLED": True, "REACT_PERCENTILE": 0.99, "FUSION_DROPOUT": 0.125, "CLASSIFIER_REBALANCE_ENABLED": True, "CLASSIFIER_REBALANCE_LOGIT_ADJUSTMENT_TAU": 1.10},
    },
    "strawberry__leaf": {
        ...
        "oe_enabled": True, "oe_w": 0.45, "allow_under_min": False,
        "defaults": {"EPOCHS": 24, "BATCH_SIZE": 88, "LEARNING_RATE": 1.2e-4, "LORA_R": 24, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.125, "OOD_FACTOR": 2.0, "LABEL_SMOOTHING": 0.10, "EARLY_STOPPING_PATIENCE": 5, "OE_LOSS_WEIGHT": 0.45, "REACT_ENABLED": True, "REACT_PERCENTILE": 0.99, "FUSION_DROPOUT": 0.10, "CLASSIFIER_REBALANCE_ENABLED": False},
    },
    "tomato__fruit": {
        ...
        "oe_enabled": True, "oe_w": 0.30, "allow_under_min": False,
        "defaults": {"EPOCHS": 30, "BATCH_SIZE": 64, "LEARNING_RATE": 6e-5, "LORA_R": 24, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.125, "OOD_FACTOR": 3.0, "LABEL_SMOOTHING": 0.10, "OE_LOSS_WEIGHT": 0.30, "REACT_ENABLED": True, "REACT_PERCENTILE": 0.985, "FUSION_DROPOUT": 0.125, "AUGMENTATION_POLICY": "augmix", "CLASSIFIER_REBALANCE_ENABLED": True, "CLASSIFIER_REBALANCE_LOGIT_ADJUSTMENT_TAU": 1.15},
    },
    "tomato__leaf": {
        ...
        "oe_enabled": True, "oe_w": 0.30, "allow_under_min": False,
        "defaults": {"EPOCHS": 24, "BATCH_SIZE": 88, "LEARNING_RATE": 8.5e-5, "LORA_R": 32, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.125, "OOD_FACTOR": 4.0, "LABEL_SMOOTHING": 0.10, "OE_LOSS_WEIGHT": 0.30, "REACT_ENABLED": True, "REACT_PERCENTILE": 0.985, "FUSION_DROPOUT": 0.10, "CLASSIFIER_REBALANCE_ENABLED": True, "CLASSIFIER_REBALANCE_LOGIT_ADJUSTMENT_TAU": 1.10},
    },
    "apricot__fruit": {
        ...
        "oe_enabled": True, "oe_w": 0.30, "allow_under_min": False,
        "defaults": {"EPOCHS": 36, "BATCH_SIZE": 40, "LEARNING_RATE": 1e-4, "LORA_R": 20, "LORA_ALPHA": 20, "LORA_DROPOUT": 0.20, "OOD_FACTOR": 2.25, "LABEL_SMOOTHING": 0.12, "OE_LOSS_WEIGHT": 0.30, "REACT_ENABLED": True, "REACT_PERCENTILE": 0.985, "FUSION_DROPOUT": 0.12, "CLASSIFIER_REBALANCE_ENABLED": True, "CLASSIFIER_REBALANCE_LOGIT_ADJUSTMENT_TAU": 1.10},
    },
    "apricot__leaf": {
        ...
        "defaults": {"EPOCHS": 24, "BATCH_SIZE": 52, "LEARNING_RATE": 1.2e-4, "LORA_R": 20, "LORA_ALPHA": 24, "LORA_DROPOUT": 0.10, "OOD_FACTOR": 4.0, "LABEL_SMOOTHING": 0.10, "OE_LOSS_WEIGHT": 0.30, "REACT_ENABLED": True, "REACT_PERCENTILE": 0.985, "FUSION_DROPOUT": 0.10, "CLASSIFIER_REBALANCE_ENABLED": True, "CLASSIFIER_REBALANCE_LOGIT_ADJUSTMENT_TAU": 1.10},
    },
})
