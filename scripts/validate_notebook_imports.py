...
def test_auto_router_adapter_notebook_contract() -> None:
    ...
    for snippet in (
        ...
        "M2_PROTOTYPE_CURATION_ROOT = 'docs/demo_assets/prototype_curation/20260624T200654Z'",
        "M2_COMPARISON_BASELINE = 'docs/demo_results/m2/20260624T200654Z/summary.json'",
