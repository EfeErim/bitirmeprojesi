...
def test_auto_router_adapter_notebook_contract() -> None:
    ...
    for snippet in (
        ...
        "M2_PROTOTYPE_CURATION_ROOT = 'docs/demo_assets/prototype_curation/20260629T124253Z_router_refinement'",
    ...
    for snippet in (
        ...
        'M2_ADAPTER_BATCH_SIZE = int(globals().get("M2_ADAPTER_BATCH_SIZE", 8))',
