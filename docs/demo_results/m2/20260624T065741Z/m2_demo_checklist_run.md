...
- started_at: `2026-06-24T06:21:13.700336+00:00`
- finished_at: `2026-06-24T06:57:39.547058+00:00`
- elapsed: `36m 26s` (2185.847s)
- generated_at: `2026-06-24T06:57:39.547058+00:00`
...
- handoff_cache: `{"enabled": true, "path": "/content/bitirmeprojesi/.runtime_tmp/m2_router_prototype_handoff_cache.json", "refresh": false, "stats": {"hits": 0, "misses": 522, "writes": 522}}`
...
- failed: 122
- answered: 427
- abstained_or_reviewed: 95
- asset_ready: 0
- failure_buckets: `{"router": 72}`
...
| demo_384 | success | pass |  | tomato / fruit / domates_gray_mold_meyve |  |
...
| demo_515 | unknown_crop | pass |  | potato / leaf /  | Router crop 'potato' is outside the final demo supported crop set. |
| demo_516 | unknown_crop | pass |  | potato / leaf /  | Router crop 'potato' is outside the final demo supported crop set. |
| demo_517 | unknown_crop | pass |  | lemon / unknown /  | Part abstained for crop=lemon: no compatible parts configured for crop (lemon) |
| demo_518 | router_uncertain | pass |  | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_519 | unknown_crop | pass |  |  /  /  | No SAM3 instances for prompts=plant,leaf,fruit,stem threshold=0.60. |
| demo_520 | unknown_crop | pass |  | pear / unknown /  | Part abstained for crop=pear: no compatible parts configured for crop (pear) |
| demo_521 | unknown_crop | pass |  | pear / unknown /  | Part abstained for crop=pear: no compatible parts configured for crop (pear) |
| demo_522 | unknown_crop | pass |  | pear / unknown /  | Part abstained for crop=pear: no compatible parts configured for crop (pear) |
| demo_523 | unknown_crop | pass |  | potato / leaf /  | Router crop 'potato' is outside the final demo supported crop set. |
| demo_524 | unknown_crop | pass |  |  /  /  | No SAM3 instances for prompts=plant,leaf,fruit,stem threshold=0.60. |
