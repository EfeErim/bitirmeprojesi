...
- Status: `fail`
- Baseline: `20260624T200654Z`
- Candidate: `20260624T225940Z`
...
| `passed_delta` | -17 |
| `failed_delta` | 17 |
| `router_failure_delta` | 23 |
| `negative_false_accept_delta` | 0 |
| `opposite_part_delta` | -1 |
| `prototype_correct_but_abstained_delta` | 25 |
...
| `tomato__leaf` | 0 | -9 | 9 |
| `tomato__fruit` | 0 | 1 | -1 |
| `apricot__fruit` | 0 | 0 | 0 |
| `strawberry__fruit` | 0 | -2 | 2 |
