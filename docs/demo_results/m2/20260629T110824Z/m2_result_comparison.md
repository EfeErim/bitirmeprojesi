...
- Status: `fail`
- Baseline: `20260628T113313Z`
- Candidate: `20260629T110824Z`
...
| `passed_delta` | -395 |
| `failed_delta` | -114 |
| `router_failure_delta` | -83 |
| `negative_false_accept_delta` | 0 |
| `opposite_part_delta` | 0 |
| `prototype_correct_but_abstained_delta` | -110 |

## Focus Target Deltas

| Target | Total Delta | Pass Delta | Fail Delta |
| --- | ---: | ---: | ---: |
| `tomato__leaf` | -102 | -80 | -22 |
| `tomato__fruit` | -70 | -50 | -20 |
| `apricot__fruit` | -60 | -39 | -21 |
| `strawberry__fruit` | -42 | -19 | -23 |
...
| `at_least_one_focus_target_improved` | fail |
