...
- router_part_correctness: `{"correct": 32, "incorrect": 57, "not_applicable": 0}`
- normalized_disease_class_correctness: `{"correct": 9, "incorrect": 5, "not_applicable": 75}`
...
- prototype_reconciliation: `{"abstain": 75, "use_prototype": 14}`
- answered_wrong_by_target: `{"strawberry__fruit": 5}`
- prototype_correct_but_abstained: 60 `{"apricot__fruit": 12, "apricot__leaf": 6, "grape__fruit": 4, "grape__leaf": 1, "strawberry__fruit": 3, "tomato__fruit": 12, "tomato__leaf": 22}`
...
| strawberry__fruit | 16 | 13 | 3 | 8 | 8 | 8 | 0 |
