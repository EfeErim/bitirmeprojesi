...
| `passed_delta` | 47 |
| `failed_delta` | -47 |
| `router_failure_delta` | -58 |
| `negative_false_accept_delta` | 0 |
| `opposite_part_delta` | 0 |
| `prototype_correct_but_abstained_delta` | -69 |
...
| `tomato__fruit` | 0 | 10 | -10 |
| `apricot__fruit` | 0 | 10 | -10 |
| `strawberry__fruit` | 0 | 9 | -9 |
