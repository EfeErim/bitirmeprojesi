...
- started_at: `2026-06-23T19:49:53.101339+00:00`
- finished_at: `2026-06-23T21:19:49.307783+00:00`
- elapsed: `1h 29m 56s` (5396.206s)
- generated_at: `2026-06-23T21:19:49.307783+00:00`
...
- failed: 146
- answered: 391
- abstained_or_reviewed: 121
- asset_ready: 0
- failure_buckets: `{"router": 108}`
...
| demo_149 | router_uncertain | fail | router | apricot / fruit /  | Adapter diagnosis 'kayısıda_yaprak_delen_çil_hastalığı_meyve_128' conflicts with routed part 'fruit'; returning review instead of a final answer. |
...
| demo_159 | router_uncertain | fail | router | apricot / fruit /  | Adapter diagnosis 'kayısıda_yaprak_delen_çil_hastalığı_meyve_128' conflicts with routed part 'fruit'; returning review instead of a final answer. |
...
| demo_163 | router_uncertain | fail | router | apricot / fruit /  | Adapter diagnosis 'kayısıda_yaprak_delen_çil_hastalığı_meyve_128' conflicts with routed part 'fruit'; returning review instead of a final answer. |
...
| demo_167 | router_uncertain | fail | router | apricot / fruit /  | Adapter diagnosis 'kayısıda_yaprak_delen_çil_hastalığı_meyve_128' conflicts with routed part 'fruit'; returning review instead of a final answer. |
| demo_168 | unknown_crop | fail | router | plum / unknown /  | Part abstained for crop=plum: no compatible parts configured for crop (plum) |
| demo_169 | router_uncertain | fail | router | apricot / fruit /  | Adapter diagnosis 'kayısıda_yaprak_delen_çil_hastalığı_meyve_128' conflicts with routed part 'fruit'; returning review instead of a final answer. |
...
| demo_178 | router_uncertain | fail | router | apricot / fruit /  | Adapter diagnosis 'kayısıda_yaprak_delen_çil_hastalığı_meyve_128' conflicts with routed part 'fruit'; returning review instead of a final answer. |
...
| demo_182 | router_uncertain | fail | router | apricot / fruit /  | Adapter diagnosis 'kayısıda_yaprak_delen_çil_hastalığı_meyve_128' conflicts with routed part 'fruit'; returning review instead of a final answer. |
| demo_183 | router_uncertain | fail | router | apricot / fruit /  | Adapter diagnosis 'kayısıda_yaprak_delen_çil_hastalığı_meyve_128' conflicts with routed part 'fruit'; returning review instead of a final answer. |
