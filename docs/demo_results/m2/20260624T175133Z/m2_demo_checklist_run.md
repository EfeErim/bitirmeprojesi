...
- started_at: `2026-06-24T17:10:42.134573+00:00`
- finished_at: `2026-06-24T17:51:32.170961+00:00`
- elapsed: `40m 50s` (2450.036s)
- generated_at: `2026-06-24T17:51:32.170961+00:00`
...
- failed: 213
- answered: 419
- abstained_or_reviewed: 183
- asset_ready: 0
- failure_buckets: `{"router": 159}`
...
| demo_525 | unknown_crop | fail | router | eggplant / unknown /  | Part abstained for crop=eggplant: no compatible parts configured for crop (eggplant) |
| demo_526 | unknown_crop | fail | router | eggplant / unknown /  | Part abstained for crop=eggplant: no compatible parts configured for crop (eggplant) |
| demo_527 | unknown_crop | fail | router | eggplant / unknown /  | Part abstained for crop=eggplant: no compatible parts configured for crop (eggplant) |
| demo_528 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_529 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_530 | unknown_crop | fail | router | eggplant / unknown /  | Part abstained for crop=eggplant: no compatible parts configured for crop (eggplant) |
| demo_531 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_532 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_533 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_534 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_535 | success | fail |  | tomato / fruit / domates_late_blight_meyve |  |
| demo_536 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_537 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_538 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_539 | success | fail |  | tomato / leaf / domates_spotted_wilt_yaprak |  |
| demo_540 | router_uncertain | fail | router | tomato / fruit /  | Router result is not eligible for adapter prediction. |
| demo_541 | unknown_crop | fail | router | quinoa / unknown /  | Part abstained for crop=quinoa: no compatible parts configured for crop (quinoa) |
| demo_542 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_543 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_544 | router_uncertain | fail | router | tomato / leaf /  | Router result is not eligible for adapter prediction. |
| demo_545 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_546 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_547 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_548 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_549 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_550 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_551 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_552 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_553 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_554 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_555 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_556 | success | fail |  | strawberry / leaf / strawberry_leaf_spot_leaf |  |
| demo_557 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_558 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_559 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_560 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_561 | success | fail |  | strawberry / leaf / strawberry_leaf_spot_leaf |  |
| demo_562 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_563 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_564 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_565 | success | fail |  | grape / fruit / u_zu_m_sag_lıklı_meyve |  |
| demo_566 | unknown_crop | fail | router | honeydew / unknown /  | Part abstained for crop=honeydew: no compatible parts configured for crop (honeydew) |
| demo_567 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
| demo_568 | success | fail |  | grape / fruit / u_zu_m_mildiyo_meyve |  |
| demo_569 | success | fail |  | grape / leaf / üzüm_antraknoz_yaprak |  |
| demo_570 | unknown_crop | fail | router | plum / unknown /  | Part abstained for crop=plum: no compatible parts configured for crop (plum) |
| demo_571 | success | fail |  | grape / leaf / üzüm_kav_esca_yaprak |  |
| demo_572 | success | fail |  | grape / leaf / üzüm_yelpaze_virüsü_yaprak |  |
| demo_573 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
| demo_574 | success | fail |  | grape / fruit / u_zu_m_sag_lıklı_meyve |  |
| demo_575 | unknown_crop | fail | router | orange / unknown /  | Part abstained for crop=orange: no compatible parts configured for crop (orange) |
| demo_576 | router_uncertain | fail | router | grape / unknown /  | Part abstained for crop=grape: confidence (0.3806) < threshold (0.4000) |
| demo_577 | router_uncertain | fail | router | grape / fruit /  | Router result is not eligible for adapter prediction. |
| demo_578 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
| demo_579 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
| demo_580 | success | fail |  | grape / leaf / üzüm_mildiyö_yaprak |  |
| demo_581 | unknown_crop | fail | router | lambsquarters / unknown /  | Part abstained for crop=lambsquarters: no compatible parts configured for crop (lambsquarters) |
| demo_582 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
| demo_583 | success | fail |  | grape / leaf / üzüm_antraknoz_yaprak |  |
| demo_584 | success | fail |  | grape / leaf / üzüm_sağlıklı_yaprak |  |
| demo_585 | unknown_crop | fail | router | pear / unknown /  | Part abstained for crop=pear: no compatible parts configured for crop (pear) |
| demo_586 | unknown_crop | fail | router | plum / unknown /  | Part abstained for crop=plum: no compatible parts configured for crop (plum) |
| demo_587 | unknown_crop | fail | router | almond / unknown /  | Part abstained for crop=almond: no compatible parts configured for crop (almond) |
| demo_588 | unknown_crop | fail | router | cotton / unknown /  | Part abstained for crop=cotton: no compatible parts configured for crop (cotton) |
| demo_589 | unknown_crop | fail | router | plum / unknown /  | Part abstained for crop=plum: no compatible parts configured for crop (plum) |
| demo_590 | unknown_crop | fail | router |  /  /  | SAM3 produced 1 instances for prompts=plant,leaf,fruit,stem but retained 0 detections after ROI filtering/classification (roi_seen=1, roi_kept=0, classification_min_confidence=0.25). |
| demo_591 | unknown_crop | fail | router | plum / unknown /  | Part abstained for crop=plum: no compatible parts configured for crop (plum) |
| demo_592 | unknown_crop | fail | router |  /  /  | No SAM3 instances for prompts=plant,leaf,fruit,stem threshold=0.60. |
| demo_593 | unknown_crop | fail | router | plum / unknown /  | Part abstained for crop=plum: no compatible parts configured for crop (plum) |
| demo_594 | unknown_crop | fail | router | almond / unknown /  | Part abstained for crop=almond: no compatible parts configured for crop (almond) |
| demo_595 | success | fail |  | apricot / leaf / kayısı_yaprak_delen_çil_hastalığı_yaprak_300 |  |
| demo_596 | unknown_crop | fail | router |  /  /  | No SAM3 instances for prompts=plant,leaf,fruit,stem threshold=0.60. |
| demo_597 | unknown_crop | fail | router | cherry / unknown /  | Part abstained for crop=cherry: no compatible parts configured for crop (cherry) |
| demo_598 | unknown_crop | fail | router | almond / unknown /  | Part abstained for crop=almond: no compatible parts configured for crop (almond) |
| demo_599 | unknown_crop | fail | router |  /  /  | No SAM3 instances for prompts=plant,leaf,fruit,stem threshold=0.60. |
| demo_600 | unknown_crop | fail | router | honeydew / unknown /  | Part abstained for crop=honeydew: no compatible parts configured for crop (honeydew) |
| demo_601 | unknown_crop | fail | router | plum / unknown /  | Part abstained for crop=plum: no compatible parts configured for crop (plum) |
| demo_602 | unknown_crop | fail | router | cherry / unknown /  | Part abstained for crop=cherry: no compatible parts configured for crop (cherry) |
| demo_603 | unknown_crop | fail | router | cherry / unknown /  | Part abstained for crop=cherry: no compatible parts configured for crop (cherry) |
| demo_604 | unknown_crop | fail | router | plum / unknown /  | Part abstained for crop=plum: no compatible parts configured for crop (plum) |
