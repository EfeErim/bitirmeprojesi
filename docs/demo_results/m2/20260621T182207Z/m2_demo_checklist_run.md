...
- generated_at: `2026-06-21T18:22:05.396786+00:00`
...
- failed: 232
- answered: 301
- abstained_or_reviewed: 211
- asset_ready: 0
- failure_buckets: `{"router": 199}`
...
| demo_007 | unknown_crop | fail | router | potato / unknown /  | Part abstained for crop=potato: confidence (0.3829) < threshold (0.4000) |
...
| demo_072 | router_uncertain | fail | router | strawberry / unknown /  | Part abstained for crop=strawberry: confidence (0.1831) < threshold (0.4000); margin (0.0077) < threshold (0.1000) |
...
| demo_091 | router_uncertain | fail | router | grape / fruit /  | Router result is not eligible for adapter prediction. |
...
| demo_098 | router_uncertain | fail | router | grape / fruit /  | Router result is not eligible for adapter prediction. |
...
| demo_221 | router_uncertain | fail | router | grape / fruit /  | Router result is not eligible for adapter prediction. |
...
| demo_267 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
| demo_268 | success | pass |  | grape / leaf / üzüm_mildiyö_yaprak |  |
| demo_269 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
| demo_270 | success | pass |  | grape / leaf / üzüm_mildiyö_yaprak |  |
| demo_271 | success | pass |  | grape / leaf / üzüm_mildiyö_yaprak |  |
| demo_272 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
...
| demo_284 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
...
| demo_286 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
...
| demo_294 | router_uncertain | fail | router | grape / leaf /  | Router result is not eligible for adapter prediction. |
...
| demo_306 | router_uncertain | fail | router | strawberry / fruit /  | Router result is not eligible for adapter prediction. |
...
| demo_342 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_343 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_344 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
| demo_345 | router_uncertain | fail | router | strawberry / leaf /  | Router result is not eligible for adapter prediction. |
