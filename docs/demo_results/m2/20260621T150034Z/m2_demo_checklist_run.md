...
- generated_at: `2026-06-21T15:00:29.757605+00:00`
...
- failed: 320
- answered: 235
- abstained_or_reviewed: 277
- asset_ready: 0
- failure_buckets: `{"router": 264}`
...
| demo_035 | success | fail |  | strawberry / leaf / strawberry_leaf_spot_leaf |  |
...
| demo_089 | success | fail |  | grape / leaf / üzüm_antraknoz_yaprak |  |
...
| demo_237 | success | pass |  | grape / fruit / u_zu_m_antraknoz_meyve |  |
...
| demo_252 | router_uncertain | fail | router | grape / unknown /  | Part abstained for crop=grape: confidence (0.2583) < threshold (0.4000); margin (-0.2166) < threshold (0.1000) |
...
| demo_313 | router_uncertain | fail | router | strawberry / unknown /  | Part abstained for crop=strawberry: confidence (0.3321) < threshold (0.4000) |
...
| demo_430 | router_uncertain | fail | router | tomato / unknown /  | Part abstained for crop=tomato: confidence (0.2670) < threshold (0.4000); margin (0.0233) < threshold (0.1000) |
...
| demo_454 | router_uncertain | fail | router | tomato / unknown /  | Part abstained for crop=tomato: confidence (0.2688) < threshold (0.4000); margin (0.0435) < threshold (0.1000) |
...
| demo_491 | router_uncertain | fail | router | tomato / unknown /  | Part abstained for crop=tomato: confidence (0.3399) < threshold (0.4000) |
