...
- [notebook8_m2_run_state.md](notebook8_m2_run_state.md): current Notebook 8 M2 next-run settings and automatic post-run adjustment rules
...
- [architecture/open_world_router_hardening_plan.md](architecture/open_world_router_hardening_plan.md): open-world router production-gate plan, manifest, preflight, Colab/GPU run, and result-validation commands
...
- [architecture/open_world_router_hardening_plan.md](architecture/open_world_router_hardening_plan.md)
